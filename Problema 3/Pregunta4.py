""" osto Total en Combustible:
○ Si el costo del combustible es de 1632 pesos chilenos por litro, ¿cuál es el costo total
del combustible necesario para el viaje desde Santiago a Copiapó?"""
...
# Costo del combustible (1632 pesos chilenos por litro)
if combustible_necesario is not None:
    costo_combustible = combustible_necesario * 1632
    print(f"Costo total del combustible necesario para el viaje desde Santiago a Copiapó: {costo_combustible:.2f} pesos chilenos")
else:
    print("No se puede calcular el costo del combustible porque no hay una ruta directa a Copiapó")