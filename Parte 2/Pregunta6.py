...
index_E2 = nodes.index("E2")
index_D10 = nodes.index("D10")
shortest_path_indices = reconstruct_path(predecessor, index_E2, index_D10)
shortest_path_nodes = [nodes[idx] for idx in shortest_path_indices]

# Obtener el costo mínimo
min_cost_E2_D10 = cost_matrix[index_E2][index_D10]

# Imprimir el costo mínimo y la ruta más corta
print(f"El costo mínimo desde E2 hasta D10 es: {min_cost_E2_D10} pesos")
